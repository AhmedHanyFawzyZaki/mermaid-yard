    ...
    public function actionCreate() {
        ...
        if (isset($_POST['Testimonial'])) {
            ...
            if (!empty($uploadedFile)) {
                ...
                $uploadedFile->saveAs(Yii::app()->basePath . '/../media/testimonials/' . $fileName);
            }
        ...
        if (isset($_POST['Testimonial'])) {
            ...
            if (!empty($uploadedFile)) {
                ...
                if ($model->image == '') {
                    ...
                    unlink(Yii::app()->basePath . '/../media/testimonials/' . $model->image);
                ...
                $uploadedFile->saveAs(Yii::app()->basePath . '/../media/testimonials/' . $model->image);
            }
            if ($model->save())
                $this->redirect(array('view', 'id' => $model->id));
        }
